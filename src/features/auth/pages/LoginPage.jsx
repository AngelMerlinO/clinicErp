...
const LoginPage = () => {
  // Opcional: detectar y aplicar modo oscuro según localStorage
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center">
                <input type="checkbox" className="h-4 w-4 text-sky-600 border-gray-300 dark:border-gray-600 rounded" />
            ...
            <button
              type="submit"
              className="w-full bg-sky-600 hover:bg-sky-700 text-white font-medium rounded-md py-3 text-base transition"
            >
              Entrar
            </button>
          </form>
